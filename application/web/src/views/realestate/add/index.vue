<template>
  <div class="app-container">
    <el-form ref="ruleForm" v-loading="loading" :model="ruleForm" :rules="rules" label-width="100px">
      ...
      <el-form-item label="充换电柜网点ID" prop="proprietor">
        <el-select v-model="ruleForm.proprietor" placeholder="请选择充换电柜网点" @change="selectGet">
          <el-option
      ...
      <el-form-item label="可放充换电小柜最大个数" prop="totalArea">
        <el-input-number v-model="ruleForm.totalArea" :precision="2" :step="0.1" :min="0" />
      </el-form-item>
      <el-form-item label="暂时使用的小柜个数" prop="livingSpace">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        proprietor: [
          { required: true, message: '请选择充换电柜网点', trigger: 'change' }
        ],
        totalArea: [
