      ...
      <el-col v-for="(val,index) in donatingList" :key="index" :span="6" :offset="1">
        <el-card class="d-buy-card">
          <div slot="header" class="clearfix">
            ...
            <el-button v-if="val.donating.donatingStatus==='归还充换电小柜中'" style="float: right; padding: 3px 0" type="text" @click="updateDonating(val,'done')">确认接收</el-button>
            <el-button v-if="val.donating.donatingStatus==='归还充换电小柜中'" style="float: right; padding: 3px 6px" type="text" @click="updateDonating(val,'cancelled')">取消</el-button>
          </div>
          <div class="item">
