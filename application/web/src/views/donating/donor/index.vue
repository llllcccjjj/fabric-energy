      ...
      <el-col v-for="(val,index) in donatingList" :key="index" :span="6" :offset="1">
        <el-card class="d-me-card">
          <div slot="header" class="clearfix">
            ...
            <el-button v-if="val.donatingStatus === '归还充换电小柜中'" style="float: right; padding: 3px 0" type="text" @click="updateDonating(val)">取消</el-button>
          </div>
          <div class="item">
            <el-tag>充换电网点ID: </el-tag>
